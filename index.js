...
// PUT YOUR CODE HERE
let myNumbers = [1, 2, 7, 5, 8]
function totalPoints(myNumbers){
  let sum = 0
...
function buildSentence(myWords){
  let sentence = ""
...
function addThreeToAll(startingNums){
  let newNums = startingNums.map(function(num){
    return num + 3
  })
  return newNums
}
...
// PUT YOUR CODE HERE
let baseNums = [4, 41, 832, 72, 89]
function squareAll(baseNums){
  let newNums = baseNums.map(function(num){
    return num * num
  })
  return newNums
}
...
// PUT YOUR CODE HERE
let numberArray = [4, 41, 832, 72, 89, 120, 431, 505, 79];
...
// PUT YOUR CODE HERE
let numArray = [4,41,832,72,89,120,431,505,70];
function greaterThan100(numArray){
  return numArray.filter(function(number){
    return number > 100
  })
}
console.log(`Q12 greaterThan100 [${numArray}]:`, greaterThan100(numArray))
...
// PUT YOUR CODE HERE
function countAdminsUsers(users){
  return users.filter(function(user){
    return user.isAdmin === true
  }).length
}
console.log(`Q14 countAdminUsers:`, countAdminsUsers(users))
...
function shorterThanX(strings, integer){
...
let manyTypes = [4, "4", "four score", 80, {age: 80}, ["nations"], {type: "free"}, "states"]
function onlyStrings(manyTypes){
  return manyTypes.filter(function(type){
...
// PUT YOUR CODE HERE
let divArray = [4,41,832,72,89,120,431,505,70]
function divisibleByTen(divArray){
  return divArray.find(function(number){
    return number % 10 === 0
  })
}
console.log(`Q19 divisibleByTen [${divArray}]:`, divisibleByTen(divArray));
...
// PUT YOUR CODE HERE
let numbers = [4,41,832,72,89,120,431,70];
function divisibleByX(numbers, integer){
...
try {
  ...
  console.log(`Q21 startsWithLetter dog:`, error)
}
